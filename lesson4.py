...
def paycheck_calc(a, b):
    return int(a) * int(b)

_, hours, rate = argv
print(paycheck_calc(hours, rate))
...
new_list_2 = [my_list[el] for el in range(1, len(my_list)) if my_list[el] > my_list[el - 1]]
print(new_list_2)

# 3. Для чисел в пределах от 20 до 240 найти числа, кратные 20 или 21. Необходимо решить задание в одну строку.
# Подсказка: использовать функцию range() и генератор.

num_list = [num for num in range(20, 241) if num % 20 == 0 or num % 21 == 0]
print(num_list)
...
new_list_4 = [old_list[el] for el in range(len(old_list)) if old_list.count(old_list[el]) == 1]
